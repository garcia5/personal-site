...
const GitLog: React.FC = () => {
  ...
  return (
    <div className="w-full font-mono text-xs bg-ctp-cust p-4 rounded-lg border border-ctp-surface0 shadow-xl overflow-hidden">
      <div className="flex flex-col gap-2 border-b border-ctp-surface1 pb-3 mb-4">
        ...
        {commits.map((commit) => (
          <div key={commit.sha} className="relative z-10 pl-4">
            ...
            <div className="text-ctp-subtext1 mb-2">
              ({new Date(commit.commit.author.date).toLocaleDateString('en-CA')}
              {' - '}
